document.addEventListener("DOMContentLoaded", () => {
  ...
  // Applies the specified theme and updates the toggle button appearance
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      if (currentDifficultyFilter === "all") {
        // "All" shows only activities with no difficulty set (open to all levels)
  ...
  function renderActivityCard(name, details) {
    ...
    activityCard.innerHTML = `
      ...
      <div class="activity-card-actions">
        ...
        <button class="share-button" aria-label="Share ${name}" title="Share this activity">
          📤 Share
        </button>
      </div>
    `;
